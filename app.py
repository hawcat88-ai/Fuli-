...
def build_tomorrow_watchlist(df):
    ...
    if not strong_watch.empty:

        strong_watch["观察类型"] = "🔥 主升观察"


        strong_watch["观察分"] = (

            strong_watch["猎手优先级"] * 0.7

            +

            strong_watch["相对市场%"].clip(
                -5,
                5
            ) * 4
    ...
    if not hidden_watch.empty:

        hidden_watch["观察类型"] = "🌱 潜伏观察"


        hidden_watch["观察分"] = (

            hidden_watch["潜伏评分"] * 0.7

            +

            hidden_watch["相对市场%"].clip(
                -5,
                5
            ) * 4
